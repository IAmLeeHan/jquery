...
(function($) {
    ...
    jQuery.playBar = {
        addBar: function(DOM, allTime) {
            ...
            $(".BarControl").append('<div class="TheBar"><div class="TimeBall"></div><div class="TheColorBar"></div></div><div class="box"><span class="BarBeginTime">00:00</span><span>&nbsp;/&nbsp;</span><span class="BarFinishTime">10:35</span></div>');
            width = $('.TheBar').width();
            times = allTime / 1000;
            rwidth = width - 8;
